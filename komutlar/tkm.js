...
exports.run = async (client, msg, args) => {
    if (!args[0]) {
        return msg.channel.send('Lütfen seçimini yap taş, kağıt yada makas & eb+t-k-m <taş,kağıt,makas>');
    }
    ...
    if (!rps.includes(choice)) {
        return msg.channel.send('Lütfen seçimini yap taş, kağıt yada makas & h!t-k-m <t,k,m>');
    }
