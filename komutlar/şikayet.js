...
exports.run = (client, message, args) => {
        ...
        let reportembed = new Discord.RichEmbed()
            ...
            .setFooter('HACKER', client.user.avatarURL)
            .setColor('36393F')
            .setTimestamp();
        reports.send(reportembed);

        message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`${target.user.tag} isimli kullanıcı şikayet edildi. ✅`).setColor('RANDOM'));
